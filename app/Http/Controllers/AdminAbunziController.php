	...
	class AdminAbunziController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Land issues','count'=>DB::table('abunzi')->sum('number_of_issues_related_to_land'),'icon'=>'fa fa-check','color'=>'red'];
			$this->index_statistic[] = ['label'=>'Border issues','count'=>DB::table('abunzi')->sum('number_of_issues_related_to_border'),'icon'=>'fa fa-check','color'=>'yellow'];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        ...
	        switch (CRUDBooster::myPrivilegeName()) {
	        	case 'Abunzi District':
	        		$query->where('district',CRUDBooster::me()->district);
	              $this->index_statistic[] = ['label'=>'Received Issues','count'=>$query->sum('total_number_of_received_issues'),'icon'=>'fa fa-check','color'=>'green'];
			$this->index_statistic[] = ['label'=>'Land issues','count'=>$query->sum('number_of_issues_related_to_land'),'icon'=>'fa fa-check','color'=>'red'];
			$this->index_statistic[] = ['label'=>'Border issues','count'=>$query->sum('number_of_issues_related_to_border'),'icon'=>'fa fa-check','color'=>'yellow'];
